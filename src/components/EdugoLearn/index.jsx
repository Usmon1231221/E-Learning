    ...
    <Container>
      ...
      <LeftContent>
        ...
        <Info>
          ...
          ab ut nemo ullam, adipisci voluptas soluta officiis dolores, molestias
          illum culpa laboriosam, vel tempore autem iure excepturi
          necessitatibus voluptatum cum?
        </Info>
        <CheckerContainer>
          {Infos.map((d, index) => (
            <Checker key={index}>
